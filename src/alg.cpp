...
namespace {
void processInputFile(std::ifstream& input_stream,
...
void writeFrequencyData(
    const std::vector<std::pair<std::string, int>>& word_frequencies) {
...
void printFreq(BST<std::string>& tree) {
  ...
  tree.traverse_helper([&frequency_data](const std::string& word, int count) {
